...
AuthorSchema.virtual("name").get(function () {
  // to avoid errors in cases where an author does not have either a fmaily name or first name
  // we wnat to make sure we handle the exception by returning an empty string for that case
  let fullname = "";
